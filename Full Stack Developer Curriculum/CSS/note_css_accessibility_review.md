...
- The width of the image will be 250px if the viewport width is less than 1000 pixels. 

- If the viewport width is greater than 1000 pixels, the width of the image will be 25vw. This is because 25vw is equal to 25% of the viewport width.
